...
import { delay, exhaustMap, retry, retryWhen, scan, share, shareReplay, switchMap } from 'rxjs/operators';
...
export class RegisterComponent implements OnInit {
  ...
  register = () => {
    ...
    this._authService.registerSeller(this.registerForm.value)
      .pipe()
      .subscribe( data => {
