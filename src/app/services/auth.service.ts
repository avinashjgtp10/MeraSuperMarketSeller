...
export class AuthService {
  ...
  getCity = () => {
    let country = ["Afghanistan", "Albania", "Algeria", "Andorra", "Angola", "Anguilla", "India"];
    return country;
  }

  getToken = (param: any) => {
    // return this._httpClient.post(environment.baseUrl + 'token', param);
    return this.httpService.post(environment.baseUrl + 'token', param)
      .pipe(map(data => data));
  }

  generateOTP = (param: any) => {
    return this.httpService.post(environment.authUrl + 'account/GenerateOTP', param)
      .pipe(map(data => data));
  }
  authorizeToken = (param: any) => {
    ...
    return this.httpService.post(environment.baseUrl + 'token', body.toString(), this.getHeader())
      .pipe(map(data => data));
  }
  ...
  registerSeller = (param: any) => {
    return this.httpService.post(environment.baseUrl + 'account/register', param,{headers:this.getAuthHeader()});
  }
